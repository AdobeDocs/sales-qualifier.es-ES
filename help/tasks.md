...
Use **[!UICONTROL Tareas]** para completar las acciones generadas por los Planes de participación. Seleccione una tarea, tome medidas, márquela como completada y continúe a la siguiente tarea sin abandonar la página.
...
* **[!UICONTROL Tareas manuales]**: llamadas telefónicas, LinkedIn InMails y revisiones de correo electrónico para los posibles clientes inscritos en un plan de participación.
* **[!UICONTROL Sugerencias del agente]**: clientes potenciales que coinciden con los criterios de segmentación de un plan de participación y que se recomiendan para la inscripción.
...
Las tareas manuales están vinculadas a los pasos del plan de participación y se dividen en tres tipos:
...
* **[!UICONTROL Plan de participación]**: el nombre del plan de participación vinculado, la fecha de vencimiento y el indicador de omisión automática, cuando corresponda.
...
* **[!UICONTROL Omitir]**: utilice esta acción cuando no pueda completar el paso pero desee mantener al cliente potencial en el plan de participación. El cliente potencial avanza al siguiente paso de cadencia.
...
* **[!UICONTROL Filtro]**—Abra el panel de filtros:
  ...
  * **[!UICONTROL Plan de participación]**: una lista de sus planes de participación en la que se puede buscar.
...
* **[!UICONTROL Buscar tareas]**: encuentre tareas por nombre de cliente potencial, nombre de empresa o plan de participación. La búsqueda se aplica con filtros activos.
...
| **[!UICONTROL Omitido]** | Ha omitido el paso o se ha omitido automáticamente. El posible cliente avanza en el plan de acuerdo. |
| **[!UICONTROL Cancelado]** | El sistema ha cancelado la tarea debido a un cambio en el plan de participación. |
...
La pestaña **[!UICONTROL Sugerencias del agente]** enumera los posibles clientes que coinciden con los criterios de segmentación de un plan de participación y se recomiendan para la inscripción. Para activar las recomendaciones, consulte [Flujos de trabajo salientes](outbound-workflows.md).
...
* **[!UICONTROL Revisar clientes potenciales]**: abra el plan de participación para revisar e inscribir a los clientes potenciales recomendados. Ver [Agregar clientes potenciales e iniciar la generación de correo electrónico](outbound-workflows.md#step-5-add-prospects-and-start-email-generation).
* **[!UICONTROL Marcar como completado]**: descarte la sugerencia después de revisarla.

La ficha **[!UICONTROL Sugerencias del agente]** incluye los filtros de estado **[!UICONTROL Actual]**, **[!UICONTROL Completado]** y **[!UICONTROL Cancelado]**, un filtro de plan de participación y la ordenación por fecha de creación.

## Completar tareas de un plan de participación

En la vista **[!UICONTROL Clientes potenciales comprometidos]** de un plan de participación, un punto de contacto manual proporciona las mismas opciones de **[!UICONTROL Marcar como completado]**, **[!UICONTROL Omitir]** y notas. Al completar una tarea, también se actualiza su estado en la página **[!UICONTROL Tareas]**. Ver [Flujos de trabajo salientes](outbound-workflows.md).
